...
public sealed class LocalizationService : ILocalizationService
{
    ...
    private static readonly Dictionary<string, IReadOnlyDictionary<string, string>> Strings = new Dictionary<string, IReadOnlyDictionary<string, string>>
    {
        ["en-US"] = new Dictionary<string, string>
        {
            ...
            ["WizardFloorPlanSummaryImageWithPageFormat"] = "Image/PDF floor plan ({0}) — page {1} of {2}",
            ...
            ["WorkspaceRenameFloorDialogTitle"] = "Rename floor or area",
            ["WorkspaceRenameFloorDialogPrimaryButton"] = "Rename",
            ["WorkspaceRenameFloorDialogCloseButton"] = "Cancel",
            ["WorkspaceDeleteFloorDialogTitle"] = "Delete floor or area",
            ["WorkspaceDeleteFloorDialogContentFormat"] = "Delete \"{0}\"? Its walls, test points, and access points are all removed. This can't be undone.",
            ["WorkspaceDeleteFloorDialogPrimaryButton"] = "Delete",
            ["WorkspaceDeleteFloorDialogCloseButton"] = "Cancel",
            ...
            ["WorkspaceReplaceSuggestionsDialogTitle"] = "Replace suggested access points?",
            ["WorkspaceReplaceSuggestionsDialogContent"] = "This floor already has suggested access points. Running Suggest Placements again replaces them — any you've manually placed or adjusted are kept.",
            ["WorkspaceReplaceSuggestionsDialogPrimaryButton"] = "Replace",
            ["WorkspaceReplaceSuggestionsDialogCloseButton"] = "Cancel",
            ["SnapshotComparisonDeleteDialogTitle"] = "Delete this snapshot?",
        ...
        ["pl-PL"] = new Dictionary<string, string>
        {
            ...
            ["WizardFloorPlanSummaryImageWithPageFormat"] = "Plan w postaci obrazu/PDF ({0}) — strona {1} z {2}",
            ...
            ["WorkspaceRenameFloorDialogTitle"] = "Zmień nazwę piętra lub obszaru",
            ["WorkspaceRenameFloorDialogPrimaryButton"] = "Zmień nazwę",
            ["WorkspaceRenameFloorDialogCloseButton"] = "Anuluj",
            ["WorkspaceDeleteFloorDialogTitle"] = "Usuń piętro lub obszar",
            ["WorkspaceDeleteFloorDialogContentFormat"] = "Usunąć „{0}”? Wszystkie jego ściany, punkty pomiarowe i punkty dostępowe zostaną usunięte. Tej operacji nie można cofnąć.",
            ["WorkspaceDeleteFloorDialogPrimaryButton"] = "Usuń",
            ["WorkspaceDeleteFloorDialogCloseButton"] = "Anuluj",
            ...
            ["WorkspaceReplaceSuggestionsDialogTitle"] = "Zastąpić sugerowane punkty dostępowe?",
            ["WorkspaceReplaceSuggestionsDialogContent"] = "To piętro ma już zasugerowane punkty dostępowe. Ponowne uruchomienie sugestii je zastąpi — punkty umieszczone lub zmienione ręcznie zostaną zachowane.",
            ["WorkspaceReplaceSuggestionsDialogPrimaryButton"] = "Zastąp",
            ["WorkspaceReplaceSuggestionsDialogCloseButton"] = "Anuluj",
            ["SnapshotComparisonDeleteDialogTitle"] = "Usunąć ten zapis?",
