...
This directory records significant architectural decisions for Pulsemap — the "why," not the mechanics already visible in the code. Use [template.md](template.md) for new ADRs.
